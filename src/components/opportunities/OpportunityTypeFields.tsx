...
const OpportunityCard: React.FC<OpportunityCardProps> = ({
  ...
  return (
    <Card
      className={cn(
        'glass-card transition-all duration-200 hover:translate-y-[-2px] hover:shadow-lg',
        className
      )}
    >
      <CardHeader>
        {/* Title */}
        <CardTitle className="text-xl">{opportunity.display_name}</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        {TypeSpecificFields && <TypeSpecificFields opportunity={opportunity} />}
