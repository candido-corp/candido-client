...
import actionRegisterEmailResend from '../actions/auth/actionRegisterEmailResend';
...
export const authRoutes = (
...
): RouteObject[] => [
  {
    ...
    children: [
      ...
      {
        path: EnumRoutes.REGISTER_EMAIL_RESEND,
        action: actionRegisterEmailResend(notificationContext),
      },
    ],
  },
  {
