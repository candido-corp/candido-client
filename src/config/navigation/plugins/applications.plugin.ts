...
registerNavigationPlugin({
  ...
  sidebar: [
    ...
    },
    {
      ...
      title: 'Completed',
      parentId: 'history',
      url: EnumRoutes.APPLICATIONS_HISTORY + '#completed',
      icon: CircleCheck,
    },
    {
      id: 'history-expired',
      title: 'Expired',
      parentId: 'history',
      url: EnumRoutes.APPLICATIONS_HISTORY + '#expired',
      icon: ClockAlert,
    },
    ...
    {
      id: 'submitted-on-going',
      title: 'On going',
      parentId: 'submitted',
      url: EnumRoutes.APPLICATIONS_SUBMITTED + '#on-going',
      icon: CircleDot,
    },
    {
      ...
      title: 'Under review',
      parentId: 'submitted',
      url: EnumRoutes.APPLICATIONS_SUBMITTED + '#under-review',
